...
final class TabController: NSObject {
    ...
    /// A tab's telemetry as cost entries — one per billed pane, each priced at
    /// its own model (a split tab can run different models side by side), with
