// Generated from tree-sitter-swift queries/highlights.scm (with-generated-files branch).
// Embedded as a raw string literal so no SwiftPM resource bundle has to be packaged
// into the .app (build-app.sh copies only binaries). The C parser is statically linked.
import Foundation

let treeSitterSwiftHighlightsQuery = #"""
[
  "."
  ";"
  ":"
